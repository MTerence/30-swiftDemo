...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setup3DTouch(app:UIApplication){
        let loveActionIcon = UIApplicationShortcutIcon(type: UIApplicationShortcutIcon.IconType.love)
        let loveItem = UIApplicationShortcutItem(type: "LoveItem", localizedTitle: "Terence", localizedSubtitle: "Amen", icon: loveActionIcon, userInfo: nil)
